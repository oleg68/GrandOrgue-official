...
const GOElementCreator::ButtonDefinitionEntry BUTTON_DEFS[] = {
  {wxT("Prev"), ID_SETTER_PREV, true, true, false, &MIDI_CONTEXT_SETTER},
  ...
  {wxT("Insert"), ID_SETTER_INSERT, true, true, false, &MIDI_CONTEXT_SETTER},
  ...
  {KEY_REFRESH_FILES,
   ...
   false,
   &MIDI_CONTEXT_SETTER},
  {KEY_PREV_FILE, ID_SETTER_PREV_FILE, true, true, false, &MIDI_CONTEXT_SETTER},
  {KEY_NEXT_FILE, ID_SETTER_NEXT_FILE, true, true, false, &MIDI_CONTEXT_SETTER},
  {KEY_LOAD_FILE, ID_SETTER_LOAD_FILE, true, true, false, &MIDI_CONTEXT_SETTER},
...
GOSetter::GOSetter(GOOrganController *organController)
  : m_OrganController(organController),
    ...
    m_general(0),
    m_crescendo(0),
    m_CurrFileDisplay(*organController, &MIDI_CONTEXT_SETTER),
    m_PosDisplay(*organController, &MIDI_CONTEXT_SETTER),
    m_BankDisplay(*organController, &MIDI_CONTEXT_SETTER),
    m_CrescendoDisplay(*organController, &MIDI_CONTEXT_SETTER),
    m_TransposeDisplay(*organController, &MIDI_CONTEXT_SETTER),
