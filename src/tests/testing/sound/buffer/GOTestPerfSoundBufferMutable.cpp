...
// Baseline values updated based on CI history (5 runs, 2026-08-19..08-24):
// the original -25%-of-single-local-run margin was too tight for GitHub's
// shared runners; retuned to -10% of the observed CI minimum.
static constexpr GOTestPerfSoundBufferBaseline BASELINE_ADD_CHANNEL_FROM_MONO[]
  = {
#ifdef NDEBUG
    {32, 1800},  // lowered: min observed 2009.9, -10% margin
    {128, 2500}, // lowered: min observed 2769.0, -10% margin
    {512, 2550}, // lowered: min observed 2860.9, -10% margin
    {2048, 2700} // lowered: min observed 2992.1, -10% margin
#else
    {32, 810},   // debug, lowered: min observed 897.3, -10% margin
    {128, 1050}, // debug, lowered: min observed 1172.8, -10% margin
    {512, 1150}, // debug, lowered: min observed 1283.3, -10% margin
    {2048, 1250} // debug, lowered: min observed 1399.3, -10% margin
#endif
};
