...
#ifndef GOTESTSOUNDORGANENGINEFACTORY_H
#define GOTESTSOUNDORGANENGINEFACTORY_H
 ...
 */
class GOTestSoundOrganEngineFactory : public GOTest {
private:
...
#endif /* GOTESTSOUNDORGANENGINEFACTORY_H */
